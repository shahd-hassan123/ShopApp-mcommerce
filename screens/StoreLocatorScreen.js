...
import {View, Text, StyleSheet, TouchableOpacity,ActivityIndicator, FlatList
} from 'react-native'
...
const STORES = [
{id: '1',name: 'ShopApp Downtown',address: '123 Main Street, Downtown',
phone: '+1 234 567 890',hours: 'Mon-Sat 9am-9pm',latitude: 37.7849,longitude: -122.4094,},
{id: '2',name: 'ShopApp Mall Branch',
address: '456 Mall Avenue, Westside',phone: '+1 234 567 891',hours: 'Daily 10am-10pm',latitude: 37.7749,longitude: -122.4194,},
{
id: '3',name: 'ShopApp Express',address: '789 Quick Lane, Eastside',phone: '+1 234 567 892',
hours: 'Mon-Fri 8am-8pm',latitude: 37.7649,longitude: -122.3994,},
]
export default function StoreLocatorScreen({ navigation }) {const { theme } = useThemeStore()
...
const getLocation = async () => {setLoading(true)
...
<Text style={styles.retryBtnText}>Try Again</Text></TouchableOpacity></View>)}
const mapRegion = {latitude: location?.latitude || 37.7749,
longitude: location?.longitude || -122.4194,latitudeDelta: 0.05,longitudeDelta: 0.05,}
return (<View style={[styles.container, { backgroundColor: theme.background }]}><View style={[styles.header, { backgroundColor: theme.headerBg, borderBottomColor: theme.border }]}>
...
<Text style={[styles.closeBtn, { color: theme.textSecondary }]}>✕</Text></TouchableOpacity>
</View>
...
contentContainerStyle={styles.storeList}renderItem={({ item }) => (
<TouchableOpacity style={[styles.storeItem, { backgroundColor: theme.backgroundSecondary, borderColor: theme.border }]}
...
loadingText: { marginTop: 12, fontSize: 14 },errorIcon: { fontSize: 48, marginBottom: 12 },
...
headerTitle: { fontSize: 17, fontWeight: '700' },backBtn: { fontSize: 15, color: '#6C63FF', fontWeight: '600' },
map: { flex: 1 },
storeCard: {position: 'absolute',bottom: 20,left: 16,right: 16,borderRadius: 16,padding: 16,shadowColor: '#000',
shadowOffset: { width: 0, height: 4 },shadowOpacity: 0.12,shadowRadius: 12,elevation: 6,},
storeCardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },storeName: { fontSize: 16, fontWeight: '700', flex: 1 },
closeBtn: { fontSize: 16, paddingLeft: 8 },storeAddress: { fontSize: 13, marginBottom: 4 },
storePhone: { fontSize: 13, marginBottom: 4 },storeHours: { fontSize: 13, fontWeight: '500' },
listContainer: { paddingTop: 16, paddingBottom: 20, borderTopWidth: 1 },
listTitle: { fontSize: 15, fontWeight: '700', paddingHorizontal: 16, marginBottom: 12 },storeList: { paddingHorizontal: 16 },
storeItem: { borderRadius: 12, padding: 12, marginRight: 12, width: 160, borderWidth: 1 },
storeItemIcon: { fontSize: 24, marginBottom: 6 },storeItemName: { fontSize: 13, fontWeight: '700', marginBottom: 2 },
storeItemAddress: { fontSize: 11, marginBottom: 4 },storeItemHours: { fontSize: 10, fontWeight: '500' },
})