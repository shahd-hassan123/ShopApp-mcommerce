...
searchBar: {marginHorizontal: 16,borderRadius: 12,padding: 12,fontSize: 14,borderWidth: 1,marginBottom: 16,},
categoryList: {paddingLeft: 16,marginBottom: 16,maxHeight: 50,},
categoryBtn: {paddingHorizontal: 18,paddingVertical: 10,borderRadius: 20,marginRight: 8,borderWidth: 1.5,height: 38,justifyContent: 'center',backgroundColor: 'transparent',},
categoryBtnActive: { backgroundColor: '#6C63FF', borderColor: '#6C63FF' },
categoryText: { fontSize: 13, fontWeight: '600' },categoryTextActive: { color: '#FFFFFF' },
productList: { paddingHorizontal: 12, paddingBottom: 20 },
row: { justifyContent: 'space-between', marginBottom: 12 },
card: {width: '48%',borderRadius: 16,overflow: 'hidden',borderWidth: 1,
shadowColor: '#000',shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06,shadowRadius: 8,elevation: 2,},
image: { width: '100%', height: 140, backgroundColor: '#F5F5F5' },
wishlistBtn: {position: 'absolute',top: 8,right: 8,backgroundColor: 'rgba(255,255,255,0.9)',
