...
{scanning ? (<View style={styles.scannerContainer}>
<CameraView
...
button: {backgroundColor: '#6C63FF',borderRadius: 12,paddingVertical: 14,paddingHorizontal: 40,alignItems: 'center',},
...
cancelBtn: {marginTop: 40,backgroundColor: 'rgba(0,0,0,0.5)',paddingHorizontal: 24,paddingVertical: 10,borderRadius: 20,},cancelText: { color: '#FFFFFF', fontSize: 14, fontWeight: '600' },
})
